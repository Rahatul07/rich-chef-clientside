...
const ChefRecipe = () => {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3  pb-24 mx-10 gap-3">
        ...
        <div className=" rounded-xl w-full mx-auto mt-5   glass text-center ">
      ...
      <div className="mx-10 grid grid-cols-1 lg:grid-cols-3 gap-5 pb-24">
