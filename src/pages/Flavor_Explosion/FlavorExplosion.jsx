          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center mt-10 ">
            ...
            <div className="text-white mx-5 lg:mx-10 mt-5">
              ...
              <p className="text-xl text-gray-300 mb-5">
                Best steak for Chimichurri Sauce - in South America, cuts such
                as flank, flat iron and skirt are popular for serving with
                Chimchurri Sauce because they have really great beefy flavour
                that pairs so well with this fresh, zingy sauce. However,
                Chimichurri will pair beautifully with ANY steak!
              </p>
            </div>
          </div>
        </Tilt>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center mt-10 ">
            <div className="text-white mx-5 lg:mx-10 mt-5">
              ...
              <p className="text-xl mb-5 text-gray-300">
                Coq au vin is delicious with anything starchy that can soak up
                the wine sauce, such as potatoes—mashed or roasted—or crusty
                French bread. Try coq au vin with rice, farro, couscous, egg
                noodles, or any other grains or starches you have on hand.
              </p>
            </div>
            <div className="card h-full w-auto mx-5 lg:mx-10 bg-base-100 shadow-xl ">
              <figure>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center mt-10 ">
            ...
            <div className="text-white mx-5 lg:mx-10 mt-5">
              ...
              <p className="text-xl mb-5 text-gray-300">
                ...
                Neapolitan pizza, typically made with tomatoes, mozzarella
                cheese, garlic, fresh basil, and extra-virgin olive oil. I think
                of it as a sophisticated version of your basic cheese pizza and
                also a wonderful Caprese salad, but with a crust.
              </p>
            </div>
          </div>
        </Tilt>
